...
<main class="w1000">
	...
	<p class="main-content">
		...
		25、送出啤酒饮料<br>
		2、画出因果图，如图3-2所示。<br>
		所有原因结点列在左边，所有结果结点列在右边。建立中间结点，表示处理的中间状态。中间结点：<br>
		11、投入1元硬币且押下饮料按钮<br>
		12、押下〖橙汁〗或〖啤酒〗的按钮<br>
		13、应当找5角零钱并且售货机有零钱找<br>
		14、钱已付清<br>
		<img src="images/yg-a4-i1.png" style="position:relative;left:-100px;"><br>
		3、转换成判定表：<br>
		<img src="images/yg-a4-i2.png" style="position:relative;left:-250px;"><br>
		4、写出测试用例<br>
		用例编号	有无零钱	投入金额	饮料	预期结果<br>
		  C01         	有　　	  1元     	橙汁	退回五角、送出橙汁<br>
		  C02         	有	      1元	    啤酒	退回五角、送出啤酒<br>
		  C03	        有	      5角	    橙汁	送出橙汁<br>
		  C04	        有	      5角	    啤酒	送出啤酒<br>
		  C05	        无	      1元	    橙汁	灯亮、退出1元<br>
		  C06	        无	      1元	    啤酒	灯亮，退出1元<br>
		  C07         	无	      5角	    橙汁	灯亮，送出橙汁<br>
		  C08         	无	      5角	    啤酒	灯亮、送出啤酒<br>
	</p>
