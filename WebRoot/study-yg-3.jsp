...
<main class="w1000">
	<h2 class="main-title">因果图测试基本步骤</h2>
	<p class="main-content">
		<br>
		<img src="images/yg-3-i1.png">
		(1)  分析软件规格说明书中的输入输出条件并分析出等价类，将每个输入输出赋予一个标示符；
		分析规格说明中的语义，通过这些语义来找出相应的输入与输入之间，输入与输出之间的关系。<br>
		(2)  将对应的输入与输入之间，输入与输出之间的关系关联起来，并将其中不可能的组合情况
		标注成约束或者限制条件，形成因果图。<br>
		(3)  由因果图转化成判定表。<br>
		(4)  将判定表的每一列拿出来作为依据，设计测试用例。<br><br>
	</p>
</main>
<div class="foot">
	<div class="blogroll">
