...
<div class="head">
	<div class="head-top">
		<div class="head-w1000">
			...
			<a href= "javascript:window.external.AddFavorite('file:///../测试训练者TestDojo/index.html',
			               '测试训练者TestDojo')" class="a-font-black">加入收藏</a>
		</div>
	</div>
			...
			<ul class="nav-first-ul">
				<li><a href="#" >基础知识</a>
					<ul  class="nav-second-ul">
						...
						<li><a href="findServlet?tableName=equivalence&title=划分等价类的标准&answer=0" >划分等价<br>类的标准</a></li>
						<li><a href="findServlet?tableName=equivalence&title=划分等价类的方法、原则&answer=0" >划分等价<br>类的方法<br>、原则</a></li>
						<li><a href="findServlet?tableName=equivalence&title=设计测试用例&answer=0">设计测<br>试用例</a></li>
						<li><a href="findServlet?tableName=equivalence&title=等价类的特点&answer=0" >等价类<br>的特点</a></li>
					</ul>
				</li>
				<li><a href="#" >实战演习</a>
					<ul class="nav-second-ul">
...
<main class="w1000">
	<div id="myFocus"><!--焦点图盒子-->
		...
		<div class="pic"><!--图片列表-->
			<ul>
				<li><a href="#1"><img src="images/content-img1.png"thumb="" alt="图片1来源于网络，版权属于作者" /></a></li>
				<li><a href="#2"><img src="images/content-img2.png" thumb="" alt="版权属于作者，图片2来源于网络"  /></a></li>
				<li><a href="#3"><img src="images/content-img3.png" thumb="" alt="图片3来源于网络，版权属于作者" /></a></li>
				<li><a href="#4"><img src="images/content-img4.png" thumb="" alt="版权属于作者，图片4来源于网络"/></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="content-study">
		<p>TestDojo热门推荐</p>
		<div id="study-area">
			<ol id="content-study1">
				<li><a href="findServlet?tableName=equivalence&title=等价类划分测试定义&answer=0" class="a-font-black">等价类划分测试定义</a></li>
				<li><a href="findServlet?tableName=equivalence&title=等价类的特点&answer=0" class="a-font-black">等价类的特点</a></li>
				<li><a href="findServlet?tableName=equivalence&title=划分等价类&answer=0" class="a-font-black">划分等价类</a></li>
				<li><a href="findServlet?tableName=border&title=边界值测试定义&answer=0" class="a-font-black">边界值测试定义</a></li>
				<li><a href="findServlet?tableName=border&title=边界值测试与等价划分的区别&answer=0" class="a-font-black">边界值与等价类划分的区别</a></li>
				<li><a href="findServlet?tableName=cause&title=因果图测试定义&answer=0" class="a-font-black">因果图测试定义</a></li>
				<li><a href="study-yg-3.jsp" class="a-font-black">因果图测试基本步骤</a></li>
			</ol>
			<ol id="content-study2"></ol>
		</div>
	</div>
	<div class="time">
		<canvas id="canvas">
...
<script src="js/time.js" id="zd"></script>
<script type="text/javascript">
	...
	function gaibian(){
		...
		if(kuandu<1500 && kuandu>850)
		{
			document.getElementById("canvas").style.width=kuandu+"px";
		} else if(kuandu<850)
		{
			window.open('mTestDojo.jsp','_self');
		}
		else
		{
			document.getElementById("canvas").style.width=1500+"px";
		}
	}
</script>
</body>
