...
<main class="w1000">
	<div class="con">
	<h2 class="main-title">题目3</h2>
	<p class="main-content">
		<br>
		分析中国象棋中走马的实际情况（下面未注明的均指的是对马的说明）<br>
		1、如果落点在棋盘外，则不移动棋子；<br>
		2、如果落点与起点不构成日字型，则不移动棋子；<br>
		3、如果落点处有自己方棋子，则不移动棋子；<br>
		4、如果在落点方向的邻近交叉点有棋子（绊马腿），则不移动棋子；<br>
		5、如果不属于1-4条，且落点处无棋子，则移动棋子；<br>
		6、如果不属于1-4条，且落点处为对方棋子(非老将)，则移动棋子并除去对方棋子；<br>
		7如果不属于1-4条，且落点处为对方老将，<br>
		则移动棋子，并提示战胜对方，游戏结束。写出原因和结果，画出因果图和判定表。<br>
	</p>
	<a class="answer" href="exercise-yg-a3.jsp">参考答案</a>
	</div>
</main>
<div class="foot">
	<div class="blogroll">
