...
<main class="w1000">
	<div class="con">
	<h2 class="main-title">题目1</h2>
	<p class="main-content">
		1、某软件规格说明书包含这样的要求：第一列字符必须是A或B，第二列字符必须是一个数字，
		在此情况下进行文件的修改，但如果第一列字符不正确，则给出信息L；如果第二列字符不是数字，
		则给出信息M。用因果图测试法写出测试用例。
	</p>
	<a class="answer" href="exercise-yg-a1.jsp">参考答案</a>
	</div>
</main>
<div class="foot">
	<div class="blogroll">
